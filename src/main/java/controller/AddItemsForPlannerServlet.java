...
/**
 * Servlet implementation class AddItemsForPlannerServlet
 */
@WebServlet("/addItemsForPlannerServlet")
public class AddItemsForPlannerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddItemsForPlannerServlet() {
        super();
